...
class Sphere {
  ...
  hit(ray) {
    ...
    const half_b = oc.x * ray.direction.x +
...
class Render {
  constructor(options) {
    ...
    this.defaultMaterial = options.defaultMaterial || { color: { r: 0.5, g: 0.5, b: 0.5 } };
...
const imageData = renderer.render(objects, width, height, viewportWidth, viewportHeight, focalLength);
